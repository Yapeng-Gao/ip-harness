    ...
    <div className="px-5 py-5 lg:px-8 lg:py-6">
      ...
      <div className="wb-tip wb-tip-neutral mb-3 text-xs">
        ...
        <AppLink
          ...
          to={
            caseId
              ? `/agent/agents?agent=agent-layout&case=${caseId}`
              : '/agent/agents?agent=agent-layout'
          }
        >
          布局 Agent
        </AppLink>
      ...
      <div className="mb-4 space-y-2">
        ...
        {/* 补挂向导：空态 / 手动 / 批准后同步 */}
        <div className="wb-tip wb-tip-info mb-1 !border-[color-mix(in_srgb,var(--color-accent)_28%,transparent)] !bg-accent-soft/80">
          <div className="flex flex-wrap items-center gap-2">
            <button
              type="button"
              className="ui-btn ui-btn-primary ui-btn-sm focus-ring !bg-primary-600 hover:!bg-primary-500"
