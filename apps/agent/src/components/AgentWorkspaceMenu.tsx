...
import { iamHref } from '../lib/deepLinks'
...
/**
 * Agent-local tenant/workspace switcher.
 * Cross-app「重新选择工作区」→ IAM 绝对深链（勿用 react-router /login）。
 */
export function AgentWorkspaceMenu({ variant = 'sidebar', className = '' }: Props) {
