            ...
            <ul className="divide-y divide-slate-100 p-2">
              {AGENCIES.map((ag) => (
                <li key={ag.id}>
                  ...
                  >
                    <Building2 className="mt-0.5 h-4 w-4 shrink-0 text-accent-muted" />
          ...
          <div className="flex flex-wrap gap-2">
            ...
            {selected?.status === 'blank' && (
              <button
                ...
                className="inline-flex items-center gap-1.5 rounded-lg border border-[color-mix(in_srgb,var(--color-accent)_28%,transparent)] bg-accent-soft px-4 py-2 text-sm font-medium text-accent-muted hover:bg-accent-soft focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-slate-400"
                aria-label="打包任务并派所"
              >
