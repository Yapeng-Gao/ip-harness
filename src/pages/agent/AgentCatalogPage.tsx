...
import { getStageMeta, STAGES } from '../../data/stages'
import {
  AGENT_TIER_LABEL,
  AGENT_TIER_ORDER,
  AGENT_TIER_SHORT,
...
import { AgentPickerCard } from '../../components/agent/AgentPickerCard'
import { AgentTierBadge } from '../../components/agent/AgentTierBadge'
import type { AgentTier, StageId } from '../../types'
import { resolvePreferredCaseId } from '../../utils/lastVisited'
