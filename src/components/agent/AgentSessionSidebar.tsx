import { matchSessionSearch } from '../../utils/sessionSearch'
...
import { RUN_STATUS_LABEL, getAgent, AGENT_CATALOG, AGENT_TIER_LABEL } from '../../data/agents'
import {
  sessionBizBadges,
  BIZ_BADGE_CLASS,
    ...
    <>
      <aside className="flex w-[min(13rem,40vw)] min-w-[10rem] max-w-[14.5rem] shrink-0 flex-col border-r border-slate-200 bg-white sm:w-52 lg:w-56">
                              ...
                              {badges.length > 0 && (
                                <div className="mt-0.5 flex flex-wrap gap-0.5">
                                  ...
                                  {(badges.includes('待我确认') ||
                                    ...
                                    badges.includes('待代理')) && (
                                    <AppLink
                                      to={opsInboxDeepLink({ sessionId: s.id })}
        ...
        <div className="border-t border-slate-100 px-3 py-2">
          ...
          <AppLink to="/agent/sessions" className="text-[11px] text-slate-600 hover:underline">
            全部会话 →
          </AppLink>
        </div>
      </aside>
