...
/**
 * Shared tenant/workspace switcher for Sidebar + AgentShell.
 * Outside click + Escape close; short scale-in (respects reduced-motion via CSS).
 */
export function WorkspaceMenu({ variant = 'sidebar', className = '' }: Props) {
