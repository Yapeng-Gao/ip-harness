...
| D2 | **专利挖掘** | `apps/mining` 或 workbench 模块 | 5184 或挂 workbench | 交底/技术点 → 候选发明点列表 → 评分 → 送立项/撰写 | `architecture/mining/` **规格 Pass** `3df6af8` · 样机开工 |
...
5. **当前 W4**：挖掘规格 **Pass**（`3df6af8`）→ **专利挖掘助手实现** `apps/mining:5184`  
6. ~~landscape 规格~~ **Pass**（`f0e1c28`）· 实现仍 **W5**  
7. 其后 W5 全景+激发
